...
class RemoteDataModule(private val apiKey: String) {
    ...
    @Singleton
    @Provides
    fun provideMovieRemoteDataSourceImpl(tmdbService: TMDBService): MovieRemoteDataSource {
        return MovieRemoteDataSourceImpl(tmdbService, apiKey)
    }

    @Singleton
    @Provides
    fun provideTvShowRemoteDataSourceImpl(tmdbService: TMDBService): TvShowRemoteDataSource {
        return TvShowRemoteDataSourceImpl(tmdbService, apiKey)
    }

    @Singleton
    @Provides
    fun provideArtistRemoteDataSourceImpl(tmdbService: TMDBService): ArtistRemoteDataSource {
